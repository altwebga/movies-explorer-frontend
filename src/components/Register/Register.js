      ...
      <div className="input__content">
        ...
        <input
          className={`input__element ${
            !isValid && errors.name && "input__error-activ"
          }`}
          required
        ...
        <input
          className={`input__element input__element-border ${
            !isValid && errors.name && "input__error-activ"
          }`}
          required
          name="password"
          ...
          onChange={handleChange}
        />
        <span className="input__error input__error-border">
          {errors.password}
        </span>
      </div>

      <p className={isMessage ? "input__error-reg-res" : ""}>{message}</p>
    </Form>
  );
}
